...
### if we input the “userid” command, the output will be “Userid  = the number of user IDs in the system”.
...
In this code, we utilize **‘getuid’** function from **‘glibc’** library. which returns the ID of the current user in the system.
...
Now, we can run ‘userid’ command from anywhere 🎃
